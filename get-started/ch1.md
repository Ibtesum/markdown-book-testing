...
আপনি জাভাস্ক্রিপ্ট জানেন না এখনও! আমিও জানিনা, মানে পুরোপুরি জানিনা আরকি। আমাদের কেউই জানেনে। কিন্তু একটু বেশি ভালোভাবে তো জানা শুরু করতেই পারি। 
...
জাভাস্ক্রিপ্ট কিভাবে তৈরী করা হয়েছে এবং কিভাবে এটা ঠিকভাবে মেইনটেইন করা যায়, এই বইয়ে সেটাই আলাপ করা হয়েছে। এজন্য জাভাস্ক্রিপ্টের পরিচয় এবং পদ্ধতিটা আমাদের বুঝতে হবে। প্রত্যেক JS ডেভেলপারেরই উচিত এই বিষয়গুলো ভালোভাবে বোঝা। আপনি যদি JS জানতে চান, এটা আপনার এই জার্নির **প্রথম ধাপ**। 
...
আমি জার্নি শব্দটাতে জোর দিচ্ছি। কেন? কারণ *জাভাস্ক্রিপ্ট জানা* কোন গন্তব্য নয়, এটা কেবল একটা দিকনির্দেশনা। আপনি যত সময়ই দেন না কেন, সবসময়ই আপনি নতুন কিছু পাবেন এবং এর সাথে আপনি আরেকটু ভালো করে শিখবেন। তাই পরামর্শ থাকবে এই বইটা ধুপধাপ পড়ে শেষ করে ফেলবেন না। বরং ধৈর্য ধরে অধ্যবসায়ের মাধ্যমে প্রথম পদক্ষেপগুলো নিবেন। 
...
মনে রাখবেন, যদিও এই বইটার নাম দেয়া হয়েছে, "Get Started", এটা কিন্তু *বিগিনার বা ইন্ট্রো*  বই হিশেবে লিখা হয়নি। এই বইয়ের আসল কাজ হচ্ছে, আপনাকে এই সিরিজের বাকি বইগুলোতে JS কে গভীরভাবে পড়ার জন্য প্রস্তুত করা। তাই বইটা লিখার সময় ধরে নিচ্ছি আপনার JS এর সাথে পরিচয় আগে থেকেই। অন্তত কয়েক মাসের অভিজ্ঞতা থাকতেই হবে। তাই এই *Get Started* বইটার সর্বোচ্চ মজা লুটতে হলে আগে বেশ কিছু সময় নিয়ে JS কোড লিখার অভিজ্ঞতা অর্জন করুন। 
...
এরকম সমস্যাগুলোতে, প্রায়ই TC39 পিছপা হয়ে ওয়েবের বাস্তবতা অনুযায়ী স্পেসিফিকেশন বানায়। উদাহরণ হিশেবে বলা যায়, TC39 একবার প্ল্যান করল, Array এর মধ্যে `contains(..)` মেথড যুক্ত করবে। কিন্তু পরে দেখা গেল, এই নামটা কিছু পুরনো JS Framework( যেগুলো আজও কিছু সাইটে ব্যাবহৃত হচ্ছে ) এর সাথে কনফ্লিক্ট করছে। তাই তারা নামটা এমনভাবে পালটে দিল যাতে কনফ্লিক্ট না করে। তারপর নাম হয়ে গেল `includes(..)` । একই রকম ঘটনা ঘটেছিল, হাস্যকর/ট্র্যাজিক *JS community crisis* এ যেটাটা "smooshgate"ও বলা হয়। প্ল্যান করা `flatten(..)` মেথড পরে পালটে `flat(..)` রাখা হয়। 
...
অর্থ্যাৎ, `alert(..)` আর `console.log(..)` জাভাস্ক্রিপ্ট দ্বারা সংজ্ঞায়িত নয়। কিন্তু *দেখতে* জাভাস্ক্রিপ্টের মত। এরকম বিভিন্ন ফাংশন আর অবজেক্ট মেথড আছে। এগুলা জাভাস্ক্রিপ্টের সিনট্যাক্স এর নিয়ম মেনে চলে। 
